...
Quedaron afuera a propósito: los errores del panel (`Admin*Error`), que se traducen enteros en el PR R —partirlos deja media pantalla en cada idioma—, y los de Pagopar y `MoneyError`, que nadie lee: van al log del servidor, y traducir un mensaje de diagnóstico es hacerlo más difícil de encontrar.
